...
(cl:defmethod cl:initialize-instance :after ((m <Start-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Start-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jaco_msgs-srv:<Start-request> is deprecated: use jaco_msgs-srv:Start-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Start-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Start-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jaco_msgs-srv:<Start-response> is deprecated: use jaco_msgs-srv:Start-response instead.")))

(cl:ensure-generic-function 'start_result-val :lambda-list '(m))
(cl:defmethod start_result-val ((m <Start-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaco_msgs-srv:start_result-val is deprecated.  Use jaco_msgs-srv:start_result instead.")
  (start_result m))
