...
(cl:defmethod cl:initialize-instance :after ((m <Stop-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Stop-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jaco_msgs-srv:<Stop-request> is deprecated: use jaco_msgs-srv:Stop-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Stop-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Stop-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jaco_msgs-srv:<Stop-response> is deprecated: use jaco_msgs-srv:Stop-response instead.")))

(cl:ensure-generic-function 'stop_result-val :lambda-list '(m))
(cl:defmethod stop_result-val ((m <Stop-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaco_msgs-srv:stop_result-val is deprecated.  Use jaco_msgs-srv:stop_result instead.")
  (stop_result m))
