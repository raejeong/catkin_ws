...
(cl:defmethod cl:initialize-instance :after ((m <HomeArm-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HomeArm-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jaco_msgs-srv:<HomeArm-request> is deprecated: use jaco_msgs-srv:HomeArm-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <HomeArm-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HomeArm-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jaco_msgs-srv:<HomeArm-response> is deprecated: use jaco_msgs-srv:HomeArm-response instead.")))

(cl:ensure-generic-function 'homearm_result-val :lambda-list '(m))
(cl:defmethod homearm_result-val ((m <HomeArm-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaco_msgs-srv:homearm_result-val is deprecated.  Use jaco_msgs-srv:homearm_result instead.")
  (homearm_result m))
