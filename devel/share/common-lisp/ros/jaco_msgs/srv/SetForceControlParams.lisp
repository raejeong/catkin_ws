...
(cl:defmethod cl:initialize-instance :after ((m <SetForceControlParams-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetForceControlParams-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jaco_msgs-srv:<SetForceControlParams-request> is deprecated: use jaco_msgs-srv:SetForceControlParams-request instead.")))
...
(cl:defmethod inertia_linear-val ((m <SetForceControlParams-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaco_msgs-srv:inertia_linear-val is deprecated.  Use jaco_msgs-srv:inertia_linear instead.")
  (inertia_linear m))
...
(cl:defmethod inertia_angular-val ((m <SetForceControlParams-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaco_msgs-srv:inertia_angular-val is deprecated.  Use jaco_msgs-srv:inertia_angular instead.")
  (inertia_angular m))
...
(cl:defmethod damping_linear-val ((m <SetForceControlParams-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaco_msgs-srv:damping_linear-val is deprecated.  Use jaco_msgs-srv:damping_linear instead.")
  (damping_linear m))
...
(cl:defmethod damping_angular-val ((m <SetForceControlParams-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaco_msgs-srv:damping_angular-val is deprecated.  Use jaco_msgs-srv:damping_angular instead.")
  (damping_angular m))
...
(cl:defmethod force_min_linear-val ((m <SetForceControlParams-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaco_msgs-srv:force_min_linear-val is deprecated.  Use jaco_msgs-srv:force_min_linear instead.")
  (force_min_linear m))
...
(cl:defmethod force_min_angular-val ((m <SetForceControlParams-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaco_msgs-srv:force_min_angular-val is deprecated.  Use jaco_msgs-srv:force_min_angular instead.")
  (force_min_angular m))
...
(cl:defmethod force_max_linear-val ((m <SetForceControlParams-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaco_msgs-srv:force_max_linear-val is deprecated.  Use jaco_msgs-srv:force_max_linear instead.")
  (force_max_linear m))
...
(cl:defmethod force_max_angular-val ((m <SetForceControlParams-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaco_msgs-srv:force_max_angular-val is deprecated.  Use jaco_msgs-srv:force_max_angular instead.")
  (force_max_angular m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetForceControlParams-request>)))
  ...
  "jaco_msgs/SetForceControlParamsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetForceControlParams-request)))
  "Returns string type for a service object of type 'SetForceControlParams-request"
  "jaco_msgs/SetForceControlParamsRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SetForceControlParams-request>)))
  ...
  (cl:format cl:nil "geometry_msgs/Vector3 inertia_linear~%geometry_msgs/Vector3 inertia_angular~%geometry_msgs/Vector3 damping_linear~%geometry_msgs/Vector3 damping_angular~%geometry_msgs/Vector3 force_min_linear~%geometry_msgs/Vector3 force_min_angular~%geometry_msgs/Vector3 force_max_linear~%geometry_msgs/Vector3 force_max_angular~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SetForceControlParams-request)))
  "Returns full string definition for message of type 'SetForceControlParams-request"
  (cl:format cl:nil "geometry_msgs/Vector3 inertia_linear~%geometry_msgs/Vector3 inertia_angular~%geometry_msgs/Vector3 damping_linear~%geometry_msgs/Vector3 damping_angular~%geometry_msgs/Vector3 force_min_linear~%geometry_msgs/Vector3 force_min_angular~%geometry_msgs/Vector3 force_max_linear~%geometry_msgs/Vector3 force_max_angular~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%~%float64 x~%float64 y~%float64 z~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <SetForceControlParams-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetForceControlParams-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jaco_msgs-srv:<SetForceControlParams-response> is deprecated: use jaco_msgs-srv:SetForceControlParams-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetForceControlParams-response>)))
  ...
  "jaco_msgs/SetForceControlParamsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetForceControlParams-response)))
  "Returns string type for a service object of type 'SetForceControlParams-response"
  "jaco_msgs/SetForceControlParamsResponse")
