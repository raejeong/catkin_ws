...
(cl:defmethod cl:initialize-instance :after ((m <JointAngles>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointAngles)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jaco_msgs-msg:<JointAngles> is deprecated: use jaco_msgs-msg:JointAngles instead.")))
