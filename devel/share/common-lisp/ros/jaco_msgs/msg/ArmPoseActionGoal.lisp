...
(cl:defclass <ArmPoseActionGoal> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (goal
    :reader goal
    :initarg :goal
    :type jaco_msgs-msg:ArmPoseGoal
    :initform (cl:make-instance 'jaco_msgs-msg:ArmPoseGoal)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ArmPoseActionGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ArmPoseActionGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jaco_msgs-msg:<ArmPoseActionGoal> is deprecated: use jaco_msgs-msg:ArmPoseActionGoal instead.")))
