...
(cl:defmethod cl:initialize-instance :after ((m <FingerPosition>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FingerPosition)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jaco_msgs-msg:<FingerPosition> is deprecated: use jaco_msgs-msg:FingerPosition instead.")))

(cl:ensure-generic-function 'finger1-val :lambda-list '(m))
(cl:defmethod finger1-val ((m <FingerPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaco_msgs-msg:finger1-val is deprecated.  Use jaco_msgs-msg:finger1 instead.")
  (finger1 m))

(cl:ensure-generic-function 'finger2-val :lambda-list '(m))
(cl:defmethod finger2-val ((m <FingerPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaco_msgs-msg:finger2-val is deprecated.  Use jaco_msgs-msg:finger2 instead.")
  (finger2 m))

(cl:ensure-generic-function 'finger3-val :lambda-list '(m))
(cl:defmethod finger3-val ((m <FingerPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaco_msgs-msg:finger3-val is deprecated.  Use jaco_msgs-msg:finger3 instead.")
  (finger3 m))
