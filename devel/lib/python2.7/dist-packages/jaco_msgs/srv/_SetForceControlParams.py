...
class SetForceControlParamsRequest(genpy.Message):
  ...
  _type = "jaco_msgs/SetForceControlParamsRequest"
...
"""autogenerated by genpy from jaco_msgs/SetForceControlParamsResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class SetForceControlParamsResponse(genpy.Message):
  ...
  _type = "jaco_msgs/SetForceControlParamsResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """
...
class SetForceControlParams(object):
  _type          = 'jaco_msgs/SetForceControlParams'
  _md5sum = '5c0999be3d1c60dba47ea0b2fd08231e'
