...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_6f.pack(_x.joint1, _x.joint2, _x.joint3, _x.joint4, _x.joint5, _x.joint6))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.joint1, _x.joint2, _x.joint3, _x.joint4, _x.joint5, _x.joint6,) = _struct_6f.unpack(str[start:end])
      return self
