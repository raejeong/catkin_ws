// Generated by gencpp from file jaco_msgs/SetForceControlParamsRequest.msg
// DO NOT EDIT!


#ifndef JACO_MSGS_MESSAGE_SETFORCECONTROLPARAMSREQUEST_H
#define JACO_MSGS_MESSAGE_SETFORCECONTROLPARAMSREQUEST_H
...
struct SetForceControlParamsRequest_
{
  ...
  typedef boost::shared_ptr< ::jaco_msgs::SetForceControlParamsRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::jaco_msgs::SetForceControlParamsRequest_<ContainerAllocator> const> ConstPtr;

}; // struct SetForceControlParamsRequest_

typedef ::jaco_msgs::SetForceControlParamsRequest_<std::allocator<void> > SetForceControlParamsRequest;

typedef boost::shared_ptr< ::jaco_msgs::SetForceControlParamsRequest > SetForceControlParamsRequestPtr;
typedef boost::shared_ptr< ::jaco_msgs::SetForceControlParamsRequest const> SetForceControlParamsRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::jaco_msgs::SetForceControlParamsRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::jaco_msgs::SetForceControlParamsRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::jaco_msgs::SetForceControlParamsRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::jaco_msgs::SetForceControlParamsRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::jaco_msgs::SetForceControlParamsRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::jaco_msgs::SetForceControlParamsRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::jaco_msgs::SetForceControlParamsRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::jaco_msgs::SetForceControlParamsRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::jaco_msgs::SetForceControlParamsRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::jaco_msgs::SetForceControlParamsRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x5c0999be3d1c60dbULL;
  static const uint64_t static_value2 = 0xa47ea0b2fd08231eULL;
};

template<class ContainerAllocator>
struct DataType< ::jaco_msgs::SetForceControlParamsRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "jaco_msgs/SetForceControlParamsRequest";
  }
...
template<class ContainerAllocator>
struct Definition< ::jaco_msgs::SetForceControlParamsRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::jaco_msgs::SetForceControlParamsRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::jaco_msgs::SetForceControlParamsRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::jaco_msgs::SetForceControlParamsRequest_<ContainerAllocator>& v)
  {
...
#endif // JACO_MSGS_MESSAGE_SETFORCECONTROLPARAMSREQUEST_H
